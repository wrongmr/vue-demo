    ...
    <div :class="'list'">
      ...
      <v-scroll :on-refresh="onRefresh" :on-infinite="onInfinite">
        <ul :style="{'min-height':fullHeight+'px','background-color':'#ffffff'}">
          <li class="deviceList-li" v-for="item in listdata"  v-bind:assetCode="item.assetCode">
          ...
          <li class="deviceList-li" v-for="item in downdata"  v-bind:assetCode="item.assetCode">
            <a @click="goRoute(item.assetCode)">
              <span class="deviceList-li-le">
                <img v-bind:src="item.attachmentId" />
              </span>
